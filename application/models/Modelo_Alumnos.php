...
class Modelo_Alumnos extends CI_Model { // INICIO DEL MODELO
    ...
    public function alumnoexiste($tabla,$numero_control){
      ...
      public function get_entries()
        ...
        public function obteneralumnos($carrera){
            $this->db->distinct();
            ...
            alumnos.nombre_acta, alumnos.nombre_curp, alumnos.nombre_certificado_medico,
            detalles.id_detalle, detalles.promedio_alumno, detalles.fecha_letra ");
