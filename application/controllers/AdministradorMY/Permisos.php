...
class Permisos extends CI_Controller {
	   ...
	   public function __construct(){
		 ...
		 $this->load->helper(array('form', 'url'));
	 	 ...
	 	 $this->load->model("Modelo_AsignarPermisosRoles");
	 }
	...
	public function index(){
		...
		$data = array(
			'roles' => $this->Modelo_AsignarPermisosRoles->getRoles(),
			'menus' => $this->Modelo_AsignarPermisosRoles->getMenus(),
		);

		$this->load->view('layouts/header');
		$this->load->view('layouts/aside');
		$this->load->view('admin/Vista_AdministradorDarPermisosRoles/listaRoles', $data);
	...
	public function insertarPermisos(){
		...
		// if ($this->input->is_ajax_request()) {
			...
			// } else {
				$ajax_data = $this->input->post();
				if ($this->Modelo_AsignarPermisosRoles->insert_permisos($ajax_data)) {
					$data = array('responce' => 'success', 'message' => 'xxxxx...!');
				} else {
					$data = array('responce' => 'error', 'message' => 'Fallo xxxxxx...!');
				}
			// }
	...
	public function listaPermisosAsignados() {

		$posts = $this->Modelo_AsignarPermisosRoles->listarPermisos();
