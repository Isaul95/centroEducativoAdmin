        ...
        <div class="content-wrapper" style="background-color: #060405;">
            ...
            <h1>
                <center>
                     <strong><font color="white" face="Comic Sans MS,arial,verdana">LISTA DE ORDENES</font></strong>
               </center>
             </h1>
            </section>
            <!-- Main content -->
            <section class="content">
               ...
               <strong><font color="#D34787">MESA: <?php echo $numerodemesa;?></font></strong>
                 ...
                 <h3>
                      <strong><font color="#D34787">Numero de venta: <?php echo $idventa;?></font></strong>
              
                 </h3>
                 <h3>
                      <strong><font color="#D34787">Tipo de venta: <?php echo $tipodeventa;?></font></strong>
              
                 </h3>
                 <h3>
<strong><font color="#D34787">Fecha y hora: <?php echo $Fecha."  ".str_replace("%20"," ",$Hora);?></font></strong>
...
<td><center><font color="white" face="Comic Sans MS,arial,verdana">s<h4><?php echo $ventadiariaextras->nombre;?></h4></font></center> </td>
<td><center><font color="white" face="Comic Sans MS,arial,verdana"><h4><?php echo $ventadiariaextras->cantidad;?></h4></font></center></td>
<td><center><font color="white" face="Comic Sans MS,arial,verdana">s<h4>$<?php echo $ventadiariaextras->precio_unitario;?>.00</h4></font></center></td>  
<td><center><font color="white" face="Comic Sans MS,arial,verdana"> <h4>$<?php echo $ventadiariaextras->importe;?>.00</h4></font> </center></td>
        </tr> 
                         <?php endforeach;?>  
                    <?php endif;?>
         </tr>
  ...
  <td><center><font color="white" face="Comic Sans MS,arial,verdana"><h4>$<?php echo $totalpagocambioventaparticular->pago;?>.00</h4></font></center></td>  
<td><center><font color="white" face="Comic Sans MS,arial,verdana"><h4>$<?php echo $totalpagocambioventaparticular->cambio;?>.00</h4></font></center></td>
<td><center><font color="white" face="Comic Sans MS,arial,verdana"><h4>$<?php echo $totalpagocambioventaparticular->total;?>.00</h4></font></center></td>
