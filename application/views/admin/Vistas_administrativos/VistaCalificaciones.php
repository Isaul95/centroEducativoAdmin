<!-- =============================================== -->
        ...
        <h1>
            <center><strong><font color="#D34787">Calificaciones de alumnos</font></strong></center>
...
<!-- **********************    CUADRO #2  **************************CONTADOR -->
          ...
          <h3><i class="fa fa-graduation-cap"></i></h3>
                          ...
                          <strong><p>Primer Semestre</p></strong>
                      </div>
                      <div class="icon">
...
<div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        <div class="inner">
                          ...
                          <strong>  <p>Segundo Semestre</p></strong>
                        </div>
                        <div class="icon">
    ...
    <!-- ******************    CUADRO #3   *********************** -->
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-yellow">
                <div class="inner">
                    ...
                    <h3><i class="fa fa-graduation-cap"></i></h3>
                  <strong> <p>Tercer Semestre</p></strong>
                </div>
                <div class="icon">
     ...
     <!-- ******************    CUADRO #4  *********************** -->
          ...
          <!-- <strong><font color="#D34787">  <p>Pago de Titulos*</p> </font></strong> -->
                        <strong><p>Cuarto Semestre</p></strong>
                    </div>
                    <div class="icon">
            ...
            <!-- **********************    CUADRO #2  **************************CONTADOR -->
                          <div class="col-lg-3 col-xs-6">
                              ...
                              <div class="small-box bg-green">
                                  <div class="inner">
                    <h3><i class="fa fa-graduation-cap text-secondary"></i></h3>
                                      <strong><p>Quinto Semestre</p></strong>
                                  </div>
                                  <div class="icon">
                                      <i class="fas fa-money-check-alt"></i>
                                  </div>
                          ...
                          <div class="col-lg-3 col-xs-6">
                                             ...
                                             <div class="small-box bg-aqua">
                                                 <div class="inner">
                                                   <h3><i class="fa fa-graduation-cap text-black"></i></h3>
                                                   <strong>  <p>Sexto Semestre</p></strong>
                                                 </div>
                                                 <div class="icon">
                                                     <i class="fa fa-chalkboard-teacher"></i>
                                                 </div>
                             ...
                             <!-- ******************    CUADRO #3   *********************** -->
                                 <div class="col-lg-3 col-xs-6">
                                     <div class="small-box bg-yellow">
                                         <div class="inner">
                                            <h3><i class="fa fa-graduation-cap text-black"></i></h3>
                                           <strong> <p>Septimo Semestre</p></strong>
                                         </div>
                                         <div class="icon">
                                           <i class="fa fa-user-edit"></i>
                                         </div>
                                     ...
                                     <div class="col-lg-3 col-xs-6">
                                         ...
                                         <div class="small-box bg-red">
                                             <div class="inner">
                                              <h3><i class="fa fa-graduation-cap text-black"></i></h3>
                                   <!-- <strong><font color="#D34787">  <p>Pago de Titulos*</p> </font></strong> -->
                                                 <strong><p>Octavo Semestre</p></strong>
                                             </div>
                                             <div class="icon">
                                                 <i class="fa fa-graduation-cap"></i>
                                             </div>
                           <a href="<?php echo base_url();?>Administrativos/Calificaciones/VistaCalificacionesPorSemestre?Semestre=Octavo&Num=8" class="small-box-footer">Ver Lista <i class="fa fa-arrow-circle-right"></i></a>
                                     ...
                                     <!-- **********************    CUADRO #2  **************************CONTADOR -->
                                                   <div class="col-lg-3 col-xs-6">
                                                       ...
                                                       <div class="small-box bg-green">
                                                           <div class="inner">
                                              <h3><i class="fa fa-graduation-cap text-black"></i></h3>
                                                               <strong><p>Noveno Semestre</p></strong>
                                                           </div>
                                                           <div class="icon">
                                                               <i class="fas fa-money-check-alt"></i>
                                                           </div>
                                     ...
                                     <div class="col-lg-3 col-xs-6">
                                                         ...
                                                         <div class="small-box bg-aqua">
                                                             <div class="inner">
                                                               <h3><i class="fa fa-graduation-cap text-black"></i></h3>
                                                               <strong>  <p>Decimo Semestre</p></strong>
                                                             </div>
                                                             <div class="icon">
                                                                 <i class="fa fa-chalkboard-teacher"></i>
                                                             </div>
